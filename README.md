<h1 align="center" id="docker-ansible">Docker AlmaLinux 8 Ansible</h1>
<p align="center">
  <i>AlmaLinux 8 Docker image for Ansible playbook and role testing.</i>
  <br/><br/>
  ...
  <a href="https://hub.docker.com/r/robinwalterfit/docker-almalinux8-ansible">
    <img alt="Docker pulls" src="https://img.shields.io/docker/pulls/robinwalterfit/docker-almalinux8-ansible?logo=docker&amp;style=flat-square">
  </a>
  <a href="https://github.com/robinwalterfit/docker-almalinux8-ansible/actions">
  ...
  <a href="https://github.com/robinwalterfit/docker-almalinux8-ansible/actions?query=workflow%3ABuild%20&amp;%20Push">
    <img alt="GitHub Actions - Build & Push Status" src="https://img.shields.io/github/actions/workflow/status/robinwalterfit/docker-almalinux8-ansible/build-and-push.yml?branch=main&amp;event=push&amp;style=flat-square&amp;logo=github&amp;logoColor=white">
  </a>
  ...
  <a href="https://github.com/robinwalterfit/docker-almalinux8-ansible/actions?query=workflow%3AMegaLinter+branch%3Amain">
    <img alt="MegaLinter" src="https://img.shields.io/github/actions/workflow/status/robinwalterfit/docker-almalinux8-ansible/mega-linter.yml?branch=main&amp;event=push&amp;style=flat-square&amp;logo=github&amp;logoColor=white">
  </a>
</p>
...
This project builds a minimal AlmaLinux OS 8 image for basic validation of
Ansible playbooks.
...
The image is heavily inspired by [`docker-rockylinux8-ansible`](https://github.com/geerlingguy/docker-rockylinux8-ansible)
...
- Project Repository: [https://github.com/robinwalterfit/docker-almalinux8-ansible](https://github.com/robinwalterfit/docker-almalinux8-ansible)
- Issues / Feature Requests: [https://github.com/robinwalterfit/docker-almalinux8-ansible/issues](https://github.com/robinwalterfit/docker-almalinux8-ansible/issues)
- Additional links:
  ...
  - `docker-rockylinux8-ansible`: [https://github.com/geerlingguy/docker-rockylinux8-ansible](https://github.com/geerlingguy/docker-rockylinux8-ansible)
