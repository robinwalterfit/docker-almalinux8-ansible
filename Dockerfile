...
LABEL org.opencontainers.image.authors="Robin Walter <hello@robinwalter.me>" \
    ...
    org.opencontainers.image.source="https://github.com/robinwalterfit/docker-almalinux8-ansible.git" \
    org.opencontainers.image.title="Docker AlmaLinux 8 Ansible" \
    org.opencontainers.image.url="https://github.com/robinwalterfit/docker-almalinux8-ansible" \
